...
public interface  JpaPedidosRepository extends JpaRepository<PedidosEntity, UUID> {
    ...
    List<PedidosEntity> findByStatusAndCriadoEmBefore(com.github.guilhermemonte21.Ecommerce.Modules.Pedidos.Infra.Persistence.Entity.Enum.StatusPedido status, java.time.OffsetDateTime threshold);
}
